            ...
            <table>
                ...
                @foreach($data as $item)
                    ...
                    <tr>
                        ...
                        <td>{{$item['role']}} </td>
                        <td class="">
                            <a href="./index.php?act=edit_kh&id={{$item['ma_us']}}" style="color:orange">Sửa</a>
                            <a href="./index.php?act=del_kh&id={{$item['ma_us']}}" style="color: red;margin:0 10px;" onclick="return confirm('Bạn có chắc xóa không')">Xóa</a>
                        </td>
                    </tr>
